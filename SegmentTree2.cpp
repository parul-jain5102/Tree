...
void update(int pos,int s,int e,int idx,int *tree) //Point update 
{
       if(s==e)
       {
              tree[idx]+=2;
...
void update2(int qs,int qe,int s,int e,int idx,int *tree) //Range update
{
       if(qs>qe)
              return;
       if(s==e)
